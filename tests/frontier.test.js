...
test("generated question and direction IDs have three lowercase base36 characters",()=>{assert.match(createFrontierId("question"),/^Q-[0-9a-z]{3}$/);assert.match(createFrontierId("direction"),/^D-[0-9a-z]{3}$/);});
